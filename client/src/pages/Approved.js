export const Approved = ({ data }) => {
  return (
    <>
      <button
        class="inline-block px-6 py-2.5 bg-green-700 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg  focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out mr-1.5"
        type="button"
      ...
      >
        ...
        <div class="offcanvas-body flex-grow p-4 overflow-y-auto">
          {data.map((user) =>
            user.pending == 1 ? (
              <div
                class="flex justify-between p-4 mb-4 text-sm text-green-800 border border-green-300 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 dark:border-green-800"
                role="alert"
              >
